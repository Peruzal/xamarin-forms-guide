description: When you want to render your UI differently on each platform you can use the OnPlatform XAML extension to run code for Android, iOS and UWP.
